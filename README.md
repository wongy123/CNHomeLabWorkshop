...
### Walkthrough
#### Step 1
First, navigate to [https://www.raspberrypi.com/software/](https://www.raspberrypi.com/software/) and install the Raspberry Pi Imager. This tool allows you to easily configure and flash images of many different operating systems onto your Pi. An image is basically a copy of some files, in this case the entire operating system.
